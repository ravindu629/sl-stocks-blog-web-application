...
export default function CategoryThree() {
  ...
  const currentBlogs = stockInsightsBlogs.slice(
    indexOfFirstPost,
    indexOfLastPost
  );
  ...
  for (
    let i = 1;
    i <= Math.ceil(stockInsightsBlogs.length / postsPerPage);
    i++
  ) {
    pageNumbers.push(i);
  }
        ...
        <div class="row">
          <div className="col-lg-12">
            <div className="blog-section-title">
              ...
              >
                {stockInsightsBlogs[0].category} Blog Articles
              </h2>
            </div>
            {stockInsightsBlogs.map((blog) => (
